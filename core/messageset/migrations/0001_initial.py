...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            bases=(models.Model, constants.ReadStatus),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receivers', models.ManyToManyField(help_text='\u4e0d\u9009\u5219\u53d1\u9001\u7ed9\u5168\u4f53\u7528\u6237', related_name=b'notification_receivers', verbose_name='\u63a5\u6536\u4eba', to=settings.AUTH_USER_MODEL, blank=True)),
            ],
            options={
                'verbose_name': '\u7cfb\u7edf\u901a\u77e5\u5185\u5bb9',
                'verbose_name_plural': '\u7cfb\u7edf\u901a\u77e5\u5185\u5bb9',
            },
            bases=(models.Model, constants.UsableStatus),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contents', models.TextField(verbose_name='\u5185\u5bb9')),
                ('status', models.PositiveSmallIntegerField(default=1, db_index=True, verbose_name='\u72b6\u6001', choices=[(0, '\u7981\u7528'), (1, '\u542f\u7528'), (99, '\u5220\u9664')])),
                ('receivers', models.ManyToManyField(help_text='\u4e0d\u9009\u5219\u53d1\u9001\u7ed9\u5168\u4f53\u7528\u6237', related_name=b'sitemail_receivers', verbose_name='\u63a5\u6536\u4eba', to=settings.AUTH_USER_MODEL, blank=True)),
            ],
            options={
                'verbose_name': '\u7ad9\u5185\u90ae\u4ef6\u5185\u5bb9',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receive', models.ForeignKey(related_name=b'+', verbose_name='\u6536\u4ef6\u4eba', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('sender', models.ForeignKey(related_name=b'+', verbose_name='\u53d1\u4ef6\u4eba', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'verbose_name': '\u6536\u4ef6\u7bb1',
                'verbose_name_plural': '\u6536\u4ef6\u7bb1',
            },
            bases=(models.Model, constants.MailStatus),
        ),
        migrations.CreateModel(
            name='SiteMailSend',
            fields=[
        ...
        migrations.CreateModel(
            ...
            bases=(models.Model, constants.TaskStatus),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='notification',
            name='receive',
            field=models.ForeignKey(related_name=b'+', verbose_name='\u63a5\u6536\u4eba', blank=True, to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
    ]
