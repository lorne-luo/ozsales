...
var sitemailcontentListPageVue = new CommonListPageVue({
        data: {
            list_api_tag: 'messageset:api-sitemailcontent-list',
            delete_api_tag: 'messageset:api-sitemailcontent-delete',
            detail_api_tag: 'messageset:api-sitemailcontent-detail',
