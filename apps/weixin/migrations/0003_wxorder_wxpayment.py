    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('return_code', models.CharField(blank=True, max_length=16, null=True, choices=[('FAIL', 'FAIL'), ('SUCCESS', 'SUCCESS')])),
                ('return_msg', models.CharField(max_length=128, null=True, blank=True)),
                ('result_code', models.CharField(blank=True, max_length=16, null=True, choices=[('FAIL', 'FAIL'), ('SUCCESS', 'SUCCESS')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trade_state', models.CharField(blank=True, max_length=32, null=True, choices=[('SUCCESS', '\xe6\x94\xaf\xe4\xbb\x98\xe6\x88\x90\xe5\x8a\x9f'), ('REFUND', b'\xe5\xb7\xb2\xe9\x80\x80\xe6\xac\xbe'), ('NOTPAY', '\xe6\x9c\xaa\xe4\xbb\x98\xe6\xac\xbe'), ('CLOSED', '\xe6\x94\xaf\xe4\xbb\x98\xe5\x85\xb3\xe9\x97\xad'), ('REVOKED', '\xe5\xb7\xb2\xe6\x92\xa4\xe9\x94\x80'), ('USERPAYING', '\xe6\x94\xaf\xe4\xbb\x98\xe4\xb8\xad'), ('PAYERROR', '\xe6\x94\xaf\xe4\xbb\x98\xe5\xa4\xb1\xe8\xb4\xa5')])),
