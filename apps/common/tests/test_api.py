...
class APITest(BaseWebTest):
    ...
    def test_list_api(self):
        url = reverse('common_listcreate_api', kwargs={'app_name': 'member', 'model_name': 'seller'})
