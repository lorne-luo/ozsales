...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('id', 'create_time', 'get_customer_link', 'total_amount', 'get_status_button', 'get_paid_button',
                    'sell_price_rmb', 'get_id_upload', 'profit_rmb', 'product_cost_aud', 'shipping_fee',
