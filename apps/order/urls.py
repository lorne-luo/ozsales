...
urlpatterns = [
    ...
    url(r'^order/$', views.OrderListView.as_view(), name='order-list-short'),
...
urlpatterns += [
    url(r'^order/orderproduct/list/$', views.OrderProductListView.as_view(), name='orderproduct-list'),
    url(r'^order/orderproduct/(?P<pk>\d+)/$', views.OrderProductDetailView.as_view(), name='orderproduct-detail')
]
