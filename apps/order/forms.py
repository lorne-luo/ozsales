...
class OrderUpdateForm(ModelForm):
    class Meta:
        model = Order
        fields = ['customer', 'address', 'is_paid', 'paid_time', 'status', 'total_amount', 'product_cost_aud',
                  'product_cost_rmb', 'shipping_fee', 'ship_time', 'total_cost_aud', 'total_cost_rmb',
                  'origin_sell_rmb', 'sell_price_rmb', 'profit_rmb', 'finish_time']
    ...
    def __init__(self, *args, **kwargs):
        ...
        if instance and instance.pk:
            ...
            self.fields['product_cost_aud'].widget.attrs['readonly'] = True
            self.fields['product_cost_rmb'].widget.attrs['readonly'] = True
            self.fields['shipping_fee'].widget.attrs['readonly'] = True
            self.fields['ship_time'].widget.attrs['readonly'] = True
            self.fields['total_cost_aud'].widget.attrs['readonly'] = True
            self.fields['total_cost_rmb'].widget.attrs['readonly'] = True
            self.fields['origin_sell_rmb'].widget.attrs['readonly'] = True
            self.fields['total_cost_rmb'].widget.attrs['readonly'] = True
            self.fields['sell_price_rmb'].widget.attrs['readonly'] = True
            self.fields['profit_rmb'].widget.attrs['readonly'] = True
