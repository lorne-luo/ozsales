...
urlpatterns = [
    ...
    url(r'^carriertracker/(?P<pk>\d+)/$', views.CarrierTrackerDetailView.as_view(), name='carriertracker-detail'),
    url(r'^carriertracker/(?P<pk>\d+)/edit/$', views.CarrierTrackerUpdateView.as_view(), name='carriertracker-update'),
]
