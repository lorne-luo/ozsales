...
urlpatterns = patterns('apps.seller.views',
    url(r'^login/', 'loginview', name='member-login'),
)

urlpatterns += patterns('django.contrib.auth.views',
   	url(r'^password_change/$', 'password_change', {'template_name': 'seller/password_change_form.html'}),
	url(r'^password_change/done/$', 'password_change_done', {'template_name': 'seller/password_change_done.html'}),
