    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_photo_front', models.FileField(upload_to=apps.customer.models.get_id_photo_front_path, null=True, verbose_name='ID Front', blank=True)),
                ('id_photo_back', models.FileField(upload_to=apps.customer.models.get_id_photo_back_path, null=True, verbose_name='ID Back', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(max_length=30, verbose_name='name')),
                ('remarks', models.CharField(max_length=500, null=True, verbose_name=b'remarks', blank=True)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='address',
            name='customer',
            field=models.ForeignKey(verbose_name=b'customer', to='customer.Customer'),
            preserve_default=True,
        ),
    ]
