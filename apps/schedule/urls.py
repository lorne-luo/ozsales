...
urlpatterns = (
    ...
    url(r'^dealsubscribe/(?P<pk>\d+)/$', login_required(views.DealSubscribeDetailView.as_view()), name='dealsubscribe-detail'),
    url(r'^dealsubscribe/(?P<pk>\d+)/edit/$', login_required(views.DealSubscribeUpdateView.as_view()), name='dealsubscribe-update'),
)
