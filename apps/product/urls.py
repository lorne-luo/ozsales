...
urlpatterns = [
    ...
    url(r'^product/(?P<pk>[-\w]+)/edit/$', views.ProductUpdateView.as_view(), name="product-update"),
]
...
urlpatterns += [
    ...
    url(r'^brand/(?P<pk>[-\w]+)/$', views.BrandDetailView.as_view(), name='brand-detail'),
    url(r'^brand/(?P<pk>[-\w]+)/edit/$', views.BrandUpdateView.as_view(), name='brand-update'),
]
